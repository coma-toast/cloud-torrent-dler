...
// 	autodownloadItems map[string]string
// 	mutex             *sync.RWMutex
// }

// type Data struct {
// 	State             map[string]db.DownloadItem `json:"state"`
// 	AutodownloadItems map[string]string          `json:"auto_download"`
// }
...
// 	cache.autodownloadItems = make(map[string]string)
// 	data := Data{}
...
// 	c.autodownloadItems = make(map[string]string)
// 	err := c.write()
// 	if err != nil {
// 		return err
// 	}
...
// func (c *Cache) Setstring(id string, autodownload string) error {
// 	c.mutex.Lock()
// 	defer c.mutex.Unlock()
...
// func (c *Cache) Getstring(torrentHash string) string {
// 	c.mutex.RLock()
// 	defer c.mutex.RUnlock()
// 	return c.autodownloadItems[torrentHash]
// }

// func (c *Cache) Removestring(torrentHash string) error {
// 	c.mutex.Lock()
// 	defer c.mutex.Unlock()
